...
# sentence_only_asl_bert.py

print("SENTENCE ONLY")

import os, re, ast, json, math, textwrap, random, inspect
...
# VAL thresholds (with forced τ=0.60 for Global τ@F1 reporting)
...
# TEST under forced τ=0.60 (Global τ@F1) + alternatives
...
m_req = metrics_subset(test_labels, test_pred_bin, mask_req, "REQUEST")
m_rep = metrics_subset(test_labels, test_pred_bin, mask_rep, "REPLY")
